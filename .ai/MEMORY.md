...
- Production release `v0.1.127` deployed at 2026-05-18 21:33 +08:00, then resynced after the archive commits' GHCR images succeeded. Final runtime image verified in production: `ghcr.io/jiutubaba/fx-api:latest` / `sha256:16844dca16706e43490e1bb230bfcdc94d2bedba42136f3927a38f6ec62cd764`, healthy with 0 restarts.
...
- Production deployment archive commit `c239f0a5` and final sync archive commit `b572f9bc` both succeeded on CI, GHCR Image, and Security Scan; production was synced to the final `latest` image from `b572f9bc`.
