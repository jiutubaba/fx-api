...
import (
	...
	"github.com/jiutubaba/fuxi-api/internal/setup"
	"github.com/jiutubaba/fuxi-api/internal/web"
...
func main() {
	...
	if *showVersion {
		log.Printf("伏羲API %s (commit: %s, built: %s)\n", Version, Commit, Date)
		return
	}
...
func runSetupServer() {
	...
	log.Println("Complete the setup wizard to configure 伏羲API")
